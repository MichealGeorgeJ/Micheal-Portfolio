  ...
  return (
    <div id={id}>
      ...
      <div className="row d-flex justify-content-center">
        <div className="col-lg-6 col-sm-12 text-white d-flex justify-content-center align-items-center flex-column" data-aos="flip-up"
    data-aos-offset="-300"
    data-aos-delay="100"
    ...
    data-aos-anchor-placement="top-center">
        ...
        <div className="col-lg-6 col-sm-12" data-aos="flip-down"
    data-aos-offset="-300"
    data-aos-delay="100"
    data-aos-duration="1000"
    data-aos-easing="ease-in-out"
