    ...
    <div id={id}>
      <div className="container p-2">
        ...
        <div className="row d-flex justify-content-between">
          ...
          {Object.keys(skillsData).map((category,id) => (
            <div className="col-lg-4 col-sm-6 mt-3 mb-5 " key={category}>
              <div className='d-flex justify-content-center ' >
                <h3 className=''>{category.replace(/([A-Z])/g, ' $1').trim()}</h3> 
              </div>
              <div style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px", borderRadius: ".5rem" }} className="card m-1 skill-card   projects-card h-100 m-2 p-2 item" data-aos="fade-up"
    data-aos-offset="-300"
    data-aos-delay='200'
