        ...
        <div className="row">
          <div className="col about d-flex justify-content-between flex-row ">
            <div className={`profile-text col-lg-6 col-sm-12 d-flex justify-content-start     `}>
              <div className='d-flex flex-column ml-2   '><h1  className='name  '>{typedName}</h1></div>
              <div className="developer item ml-2">
              ...
              <div className='media-icons move-left d-flex flex-row justify-content-between align-items-center'>
                <div className='col'>
                  <p><a style={{ textDecoration: "none", color: "#ffffff" }} href="https://www.linkedin.com/in/micheal-george-j-a49224248/">
                      <img className='icons' src="https://res.cloudinary.com/dkwftase4/image/upload/v1711514293/icons8-linkedin-48_ejmxlf.png" alt="" />
                  </a></p>
                </div>
                <div className='col'>
                  <p className=''><a style={{ textDecoration: "none", color: "#ffffff" }} href="https://www.instagram.com/mich43l__official/?hl=en">
                      <img className='icons' src="https://res.cloudinary.com/dkwftase4/image/upload/v1711514292/icons8-instagram-48_enib2m.png" alt="" />
                  </a></p>
                </div>
                <div className='col'>
                  <p className=''><a style={{ textDecoration: "none", color: "#ffffff" }} href="https://twitter.com/MICHEALGEO1317">
